...
@property (strong, nonatomic, nonnull) UIColor *backgroundColor UI_APPEARANCE_SELECTOR;     // default is [UIColor ClearColor]
...
+ (void)setBackgroundColor:(nonnull UIColor*)color;                 // default is [UIColor ClearColor], only used for SVProgressHUDStyleCustom
